    ...
    if request.method == "POST":
        ...
        if invitation == "7777":
            if username == "" or password == "" or confirm == "":
                ...
                if confirm == password:
                    if ManagerInfo.objects.filter(username=username).first():
                        flag = 3
                    else:
                        if ManagerInfo.objects.create(username=username, password=password):
                            flag = 1
                        else:
                            flag = 2
                else:
        ...
        if flag == -1:
            ...
            if flag == 0:
                ...
                if flag == 3:
                    ...
                    if flag == 4:
                        messages.error(request, "注册失败,邀请码错误")
                    else:
